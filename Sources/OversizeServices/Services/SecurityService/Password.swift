...
public extension SecureStorageService {
    func addPassword(_ password: String, for account: String) {
        ...
        do {
            ...
            Log.error("Failed to add password with label \(account)", error: error)
            return
        }
    }
    ...
    func updatePassword(_ password: String, for account: String) {
        ...
        do {
            ...
            Log.error("Failed to update password with label \(account)", error: error)
            return
        }
    }
    ...
    func getPassword(for account: String) -> String? {
        ...
        do {
            ...
            Log.error("Failed to get password with label \(account)", error: error)
            return nil
        }
    ...
    func deletePassword(for account: String) {
        ...
        do {
            ...
            Log.error("Failed to delete password with label \(account)", error: error)
            return
        }
    }
}
