...
public final class ResolverRegistration<Service> {
    ...
    public final func resolve(resolver: Resolver, args: Any?) -> Service? {
        scope.resolve(registration: self, resolver: resolver, args: args)
    }
...
public class ResolverScope: ResolverScopeType {
    ...
    public func resolve<Service>(registration: ResolverRegistration<Service>, resolver: Resolver, args: Any?) -> Service? {
        registration.instantiate(resolver: resolver, args: args)
    }
...
public class ResolverScopeCache: ResolverScope {
    ...
    override public func resolve<Service>(registration: ResolverRegistration<Service>, resolver: Resolver, args: Any?) -> Service? {
...
public final class ResolverScopeGraph: ResolverScope {
    ...
    override public final func resolve<Service>(registration: ResolverRegistration<Service>, resolver: Resolver, args: Any?) -> Service? {
...
public final class ResolverScopeContainer: ResolverScope {
    ...
    override public final func resolve<Service>(registration: ResolverRegistration<Service>, resolver: Resolver, args: Any?) -> Service? {
        resolver.cache.resolve(registration: registration, resolver: resolver, args: args)
    }
}
